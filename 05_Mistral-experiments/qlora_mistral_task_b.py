...
prompt_template = """<s>[INST] Category of Sexism: for posts which are sexist, a four-class classification where systems have to predict one of four categories: (1) threats, (2)  derogation, (3) animosity, (4) prejudiced discussion. 
...
def preprocess_function(examples):
    inputs = [prompt_template.replace("{POST}", text) + label  + " </s>" for text, label in zip(examples['text'], examples['label_category'])]
